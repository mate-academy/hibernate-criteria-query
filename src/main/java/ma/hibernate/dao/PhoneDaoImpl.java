...
import ma.hibernate.DataProcessingException;
...
public class PhoneDaoImpl extends AbstractDao implements PhoneDao {
    ...
    public Phone create(Phone phone) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't create phone: " + phone + " to DB.", e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public List<Phone> findAll(Map<String, String[]> params) {
        try (Session session = factory.openSession()) {
            ...
            throw new DataProcessingException("Can't find all phones by criteria.", e);
        }
    }
}
