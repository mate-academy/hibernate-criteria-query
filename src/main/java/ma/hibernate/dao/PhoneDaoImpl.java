...
public class PhoneDaoImpl extends AbstractDao implements PhoneDao {
    ...
    public List<Phone> findAll(Map<String, String[]> params) {
        try (Session session = factory.openSession()) {
            ...
            List<CriteriaBuilder.In<String>> listOfPredicates = new ArrayList<>();
            ...
            criteriaQuery.where(criteriaBuilder.and(listOfPredicates.toArray(Predicate[]::new)));
            return session.createQuery(criteriaQuery).getResultList();
        } catch (Exception e) {
            throw new DataProcessingException("Can't find all phones with parameters: "
                    + params, e);
        }
    }
}
