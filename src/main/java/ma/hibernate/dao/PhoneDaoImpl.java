...
public class PhoneDaoImpl extends AbstractDao implements PhoneDao {
    ...
    public List<Phone> findAll(Map<String, String[]> params) {
        try (Session session = factory.openSession()) {
            ...
            Root<Phone> phoneRoot = compoundQuery.from(Phone.class);
            ...
            compoundQuery.where(predicates.toArray(new Predicate[]{}));
            return session.createQuery(compoundQuery).getResultList();
        } catch (Exception e) {
            ...
            throw new RuntimeException("Can't get phones with params: "
                    + exceptionMessage, e);
        }
    }
}
